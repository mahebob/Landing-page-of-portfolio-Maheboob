...
if (state.errors) {
  ...
  return (
    <div className="bg-slate-900 text-white min-h-screen">
      ...
      >
        <div className=" max-w-40  md:max-w-4xl "><h1 className="text-green-500 mb-28 md:mb-6 text-5xl md:text-7xl animate__animated animate__flash   " >
            Hello I'm <span className="text-green-500 text-5xl md:text-7xl animate__animated animate__flash ">Maheboob</span>
          </h1>
          <p className="text-xl md:text-2xl text-white mb-28 md:mb-6   ">
     ...
     <a  href="https://wa.me/917709852396"> <FaSquareWhatsapp className="w-8 h-8 hover:text-blue-500 cursor-pointer transition-colors" /></a>
         ...
         <div className=''>
          <img src={kola}  className='rounded-xl ms-0 mt-24 md:mb-10  md:ms-36   w-28 md:w-40  '></img>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap  mb-4 ">
                  {project.tech.map(tech => (
                    <span key={tech} className="bg-slate-700  text-green-500 px-4 me-2 mt-2 py-1 gap-1 rounded-full text-sm">
                      {tech}
                    </span>
                  ))}
                </div>
